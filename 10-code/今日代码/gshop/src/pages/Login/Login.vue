...
export default {
  ...
  data() {
    return {
      loginWay: true, // true--默认是短信登录,false--是密码登录
      phone: '', // 手机号码
      computedTime: 0, // 倒计时
      isShowPwd: false, // false--默认显示密码
      code: '', //短信验证码
      name: '', //用户名
      pwd: '', // 密码
      captcha: '' // 图形验证码
  ...
  methods: {
    ...
    // 登录操作
    async login() {
      // const result = await this.$validator.validateAll() //表单整体校验
      // 判断是否成功
      // 获取所有的表单数据
